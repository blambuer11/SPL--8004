...
var ICONS = {
  add: async () => (await import("./add-NNIAZYTD.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-HXD6WNDR.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-LXFEXD3A.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-DHGJ36KR.js")).appStoreSvg,
  apple: async () => (await import("./apple-UWK2VHCP.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-ZMZ4INEP.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-PQJAV5EL.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-URRP22U3.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-SIZYGTYW.js")).arrowTopSvg,
  bank: async () => (await import("./bank-RINHFFXT.js")).bankSvg,
  browser: async () => (await import("./browser-THS4OBIA.js")).browserSvg,
  card: async () => (await import("./card-FUNLEBNX.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-GRJI7YJ6.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-MWDQDOOZ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-3JFNWXRK.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-6IXXW22T.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-LXKXBE42.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-Q3ELMILY.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-TQXJODT7.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-4MUSJJQC.js")).clockSvg,
  close: async () => (await import("./close-ZOME5UMM.js")).closeSvg,
  compass: async () => (await import("./compass-J6FM6T2S.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-EEIUYDOO.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-MVL3IQ5A.js")).copySvg,
  cursor: async () => (await import("./cursor-YZOHJIX3.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-TXBB45FN.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-QNYFNR5I.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-VU3MV7MA.js")).disconnectSvg,
  discord: async () => (await import("./discord-OQER5UJR.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-RK7BEHDI.js")).etherscanSvg,
  extension: async () => (await import("./extension-M4FDPNJH.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-WERWXNHT.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-JWJEQPI2.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-WR2MFL2P.js")).farcasterSvg,
  filters: async () => (await import("./filters-5UQA2UOY.js")).filtersSvg,
  github: async () => (await import("./github-FMAXVGLJ.js")).githubSvg,
  google: async () => (await import("./google-ZV64WSUC.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-GZIUL2Y7.js")).helpCircleSvg,
  image: async () => (await import("./image-LVCW2XXR.js")).imageSvg,
  id: async () => (await import("./id-EMF7OBYH.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-ANDYQAIC.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-JNOLKD5M.js")).lightbulbSvg,
  mail: async () => (await import("./mail-ICXWVA3D.js")).mailSvg,
  mobile: async () => (await import("./mobile-64FA7RUD.js")).mobileSvg,
  more: async () => (await import("./more-OYG5IHGC.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-L2EMFM4D.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-UGB6YS3E.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-KM7TSG3F.js")).offSvg,
  playStore: async () => (await import("./play-store-JGTPOF6G.js")).playStoreSvg,
  plus: async () => (await import("./plus-PLSH4EE4.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-GFVGNHZN.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-PX667EE2.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-B6EUFZ4V.js")).refreshSvg,
  search: async () => (await import("./search-AY67FI44.js")).searchSvg,
  send: async () => (await import("./send-WT22AEC5.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-ZHNIM3FP.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-MILXEYHJ.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-MTYMT5IH.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-YPKGZFHM.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-6LGTWUBG.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-4XXZKUGA.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-O7PE7IG6.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-GSBGXZUQ.js")).twitchSvg,
  twitter: async () => (await import("./x-6LXXYSVI.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-PTOYXURQ.js")).twitterIconSvg,
  verify: async () => (await import("./verify-T2ECWFNX.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-SIVMXISV.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-7DXJBZ3J.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-QMBKVDBY.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-QMBKVDBY.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-QMBKVDBY.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-5YUWEPOQ.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-D2MVX6LX.js")).warningCircleSvg,
  x: async () => (await import("./x-6LXXYSVI.js")).xSvg,
  info: async () => (await import("./info-ED6IOBSA.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-RDCKTYD7.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-D4J3NC77.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KO7C34UZ.js.map
