...
pub const DEFAULT_COMMISSION_RATE: u16 = 300; // 3% (in basis points: 300 / 100 = 3%)
pub const MAX_COMMISSION_RATE: u16 = 1000; // 10%

pub const REWARD_CLAIM_INTERVAL: i64 = 86400; // 24 hours

// Validator staking
pub const VALIDATOR_SEED: &[u8] = b"validator";
pub const VALIDATOR_MIN_STAKE: u64 = 100_000_000; // 0.1 SOL
pub const VALIDATOR_UNSTAKE_COOLDOWN: i64 = 7 * 24 * 60 * 60; // 7 days in seconds
