            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  size="sm"
                  disabled={/* @ts-expect-error runtime dynamic field */ agent.isWalletValid === false}
                  title={/* @ts-expect-error runtime dynamic field */ agent.isWalletValid === false ? 'Wallet adresi geçersiz - ödeme gönderilemez' : 'Hire Agent'}
                >
