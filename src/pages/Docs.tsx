...
const response = await fetch('https://noemaprotocol.xyz/api/x402/payment', {
  method: 'POST',
...
response = requests.post('https://noemaprotocol.xyz/api/x402/payment', json={
    'sender': 'AGENT_A_WALLET_ADDRESS',
    'recipient': 'AGENT_B_WALLET_ADDRESS',
    'amount': 0.5,  # USDC
...
# Server runs on https://noemaprotocol.xyz/api
# Health check: curl https://noemaprotocol.xyz/api/health`}
                      />
                    </div>
...
const x402 = new X402Client('https://noemaprotocol.xyz/api/x402');
