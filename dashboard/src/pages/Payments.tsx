...
export default function Payments() {
  ...
  const [probeUrl, setProbeUrl] = useState<string>(import.meta.env.VITE_X402_PROTECTED_URL || 'https://noemaprotocol.xyz/api/x402/payment');
            ...
            <CardContent className="space-y-4">
              ...
              {health === 'down' && (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-sm text-yellow-900">
                  ⚠️ Facilitator service is offline. Payment functionality requires a running facilitator at <code className="bg-yellow-100 px-1 py-0.5 rounded">{import.meta.env.VITE_X402_FACILITATOR_URL || 'https://noemaprotocol.xyz/api/x402'}</code>
                </div>
              )}
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    ...
                    const facilitatorUrl = import.meta.env.VITE_X402_FACILITATOR_URL || 'https://noemaprotocol.xyz/api/x402';
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="text-xs bg-muted/40 p-2 rounded border border-border/50 font-mono">
                  {import.meta.env.VITE_X402_FACILITATOR_URL || 'https://noemaprotocol.xyz/api/x402'}
                </div>
              </div>
